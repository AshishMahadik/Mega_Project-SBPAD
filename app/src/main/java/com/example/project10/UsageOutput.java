...
public class UsageOutput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usage_output);
    ...
    public void showAppsUsage(Map<String, UsageStats> mySortedMap) {
        ...
        // build the adapter
        UsagePermission adapter = new UsagePermission(this, appsList);
